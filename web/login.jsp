<%-- 
    Document   : login
    Created on : Oct 27, 2020, 7:59:57 AM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
        <c:if test="${LoginRequest!=null}">
            <title></title>
           <script language="javascript">
                   confirm("Suscess Created!");
           </script>
            </c:if>
        ...
        <div class="form-container sign-in-container">
            ...
            <input type="text" name="txtUsername" value="${param.txtUsername}" placeholder="Email" />
        ...
        <div class="overlay-panel overlay-left">
            ...
            </div><form action="registerform.jsp">
        ...
        <footer>
        <p>
        Copied  <i class="fa fa-heart"></i> by
        <a target="_blank" href="https://www.facebook.com/TA.Handez/">Handez</a>
        </p>
        </footer>
        </body>
    </html>
